...
import com.dancechar.pilivideo.common.thread.Handlers;
import com.dancechar.pilivideo.common.utils.CrashHandler;
import com.dancechar.pilivideo.core.view.IRenderView;
...
import com.dancechar.pilivideo.sdk.constant.CauseCode;
import com.dancechar.pilivideo.sdk.constant.DecryptionConfigCode;
...
abstract class BaseLivePlayer extends VodPlayer {
    ...
    @Override
    public void registerCompleteListener(NELivePlayer.OnCompletionListener listener, boolean register) {
