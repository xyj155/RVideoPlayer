...
import com.dancechar.pilivideo.sdk.constant.PreloadStatusType;
...
public class PlayerManagerImpl {
    ...
    public static void addPreloadUrl(String url) {
     ...
     * 查询预加载拉流链接地址的结果信息
     *
     * @return Map<String, Integer> String是链接地址，Integer是状态,状态码参考 {@link PreloadStatusType}
     */
