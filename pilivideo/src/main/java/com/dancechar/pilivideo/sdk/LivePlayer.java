...
public abstract class LivePlayer {
    ...
    public abstract void registerCompleteListener(NELivePlayer.OnCompletionListener listener, boolean register);
    /**
     ...
     * 获取当前播放器的状态信息
     *
     * @return 播放器当前的状态信息：状态{@link STATE}、导致该状态的原因 {@link CauseCode}
     */
